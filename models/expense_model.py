...
#
# stratify=output_categories ensures all categories appear proportionally in both sets
...
df.loc[df["final_category"].isna(),"final_category"] = unlabeled_df["predicted_category"]
...
with open("trained/expense_model.pkl", "wb") as f:
    pickle.dump(model, f)

# save TF-IDF vectorizer
with open("trained/vectorizer.pkl", "wb") as f:
    pickle.dump(vectorizer, f)

print("\nExpense model and vectorizer saved successfully.")
